       ...
       // import "@openzeppelin/contracts/token/ERC721/ERC721.sol"; 
        ...
        contract Cryptoart is ERC721,Ownable{
            ...
            function closeBidOwner(uint _tokenId) public {
               ...
               uint index;
               address seller = y.tokenOwner;
               y.tokenOwner = y.auction.bidder;
               y.isSelling = false;
               y.tokenPrice = y.auction.bidprice;
               y.tokenSellPrice = 0;
               ...
               delete z[index];
               tokensByOwner[seller] = z;
               tokensByOwner[y.auction.bidder].push(y);
                _holderTokens[seller].remove(_tokenId);
                _holderTokens[y.auction.bidder].add(_tokenId);
                
               y.auction.bidprice = 0;
               y.auction.isBidding = false;  
               y.auction.bidder = address(0x0);
